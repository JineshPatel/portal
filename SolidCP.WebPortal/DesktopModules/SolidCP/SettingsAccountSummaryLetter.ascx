...
<table>
    ...
    <tr>
        ...
        <td class="Normal" colspan="1">
            <asp:TextBox ID="txtCC" runat="server" Width="100%" CssClass="NormalTextBox"></asp:TextBox></td>
    </tr>
    <tr>
        <td class="SubHead" colspan="1"><asp:Label ID="lblSubject" runat="server" meta:resourcekey="lblSubject" Text="Subject:"></asp:Label></td>
        <td class="Normal" colspan="1">
            <asp:TextBox ID="txtSubject" runat="server" Width="100%" CssClass="NormalTextBox"></asp:TextBox></td>
    </tr>
    <tr>
