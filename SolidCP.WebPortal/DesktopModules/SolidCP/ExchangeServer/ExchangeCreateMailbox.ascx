				...
				<div class="FormBody" width="100%">
					...
					<asp:UpdatePanel ID="UpdatePanel1" 
                     ...
                     <ContentTemplate>
						...
						<tr>
							...
							<td>
                                <scp:EmailAddress id="email" runat="server" ValidationGroup="CreateMailbox">
                                </scp:EmailAddress>
                            </td>
						</tr>
                        <tr>
						...
						<tr id="PasswordBlock" runat="server">
							...
							<td>
                                <scp:PasswordControl id="password" runat="server" ValidationGroup="CreateMailbox" AllowGeneratePassword="false">
                                </scp:PasswordControl>
                    ...
                    <table>  
                        <tr>                      
                            ...
                            <td><scp:EmailControl id="sendInstructionEmail" runat="server" RequiredEnabled="true" ValidationGroup="CreateMailbox"></scp:EmailControl></td>  
                        </tr>                            
                    </table>  
