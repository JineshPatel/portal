...
<asp:Panel ID="UploadFilePanel" runat="server" CssClass="PopupContainer" style="display:none" DefaultButton="btnUpload">
	<scp:PopupHeader runat="server" meta:resourcekey="lblUploadFile" Text="Upload File" />
	<div class="Content">
		<div class="Body">
			<br />
			<div class="FormRow">
...
<asp:Panel ID="CopyFilesPanel" runat="server" CssClass="PopupContainer" style="display:none" DefaultButton="btnCopy">
	<scp:PopupHeader runat="server" meta:resourcekey="lblCopySelectedFiles" Text="Copy Selected Files" />
	<div class="Content">
		<div class="Body">
			<br />
			<div class="FormRow">
...
<asp:Panel ID="MoveFilesPanel" runat="server" CssClass="PopupContainer" style="display:none" DefaultButton="btnMove">
	<scp:PopupHeader runat="server" meta:resourcekey="lblMoveSelectedFiles" Text="Move Selected Files" />
	<div class="Content">
		<div class="Body">
			<br />
			<div class="FormRow">
...
<asp:Panel ID="CreateFilePanel" runat="server" CssClass="PopupContainer mpeTarget" style="display:none" DefaultButton="btnCreateFile">
	<scp:PopupHeader runat="server" meta:resourcekey="lblCreateFile" Text="Create Text File" />
	<div class="Content">
		<div class="FormBody">
			<div class="FormRow">
...
<asp:Panel ID="CreateFolderPanel" runat="server" CssClass="PopupContainer" style="display:none" DefaultButton="btnCreateFolder">
	<scp:PopupHeader runat="server" meta:resourcekey="lblCreateFolder" Text="Create Folder" />
	<div class="Content">
		<div class="Body">
			<br />
			<div class="FormRow">
...
<asp:Panel ID="ZipFilesPanel" runat="server" CssClass="PopupContainer" style="display:none" DefaultButton="btnZip">
	<scp:PopupHeader runat="server" meta:resourcekey="lblZipFiles" Text="Zip Selected Files" />
	<div class="Content">
		<div class="Body">
			<br />
			<div class="FormRow">
...
<asp:Panel ID="CreateDatabasePanel" runat="server" CssClass="PopupContainer" style="display:none" DefaultButton="btnCreateDatabase">
	<scp:PopupHeader runat="server" meta:resourcekey="lblCreateAccessDatabase" Text="Create Access Database" />
	<div class="Content">
		<div class="Body">
			<br />
			<div class="FormRow">
...
<asp:Panel ID="DeleteFilesPanel" runat="server" CssClass="PopupContainer" style="display:none">
	<scp:PopupHeader runat="server" meta:resourcekey="lblDeleteFiles" Text="Delete Selected Files" />
	<div class="Content">
		<div class="Body">
			<br />
			<div class="FormRow">
...
<asp:Panel ID="EditFilePanel" runat="server" CssClass="PopupContainer fileeditor" style="display:none" DefaultButton="btnSaveEditFile">
	<scp:PopupHeader runat="server" meta:resourcekey="lblEditFile" Text="Edit File" />
	<div class="Content">
		<div class="FormBody">
			<div class="FormRow">
...
<asp:Panel ID="RenameFilePanel" runat="server" CssClass="PopupContainer" style="display:none" DefaultButton="btnRename">
	<scp:PopupHeader runat="server" meta:resourcekey="lblRenameFileFolder" Text="Rename File" />
	<div class="Content">
		<div class="Body">
			<br />
			<div class="FormRow">
...
<asp:Panel ID="PermissionsFilePanel" runat="server" CssClass="PopupContainer" style="display:none">
	<scp:PopupHeader runat="server" meta:resourcekey="lblPermissions" Text="File/Folder Permissions" />
	<div class="Content">
		<div class="Body">
			<br />
