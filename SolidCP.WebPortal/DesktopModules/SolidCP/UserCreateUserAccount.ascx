...
<asp:Panel ID="UserCreatUserAccountPanel" runat="server" DefaultButton="btnCreate">
    <div class="FormBody">
        <table cellspacing="0" cellpadding="2">
            ...
            <tr>
                <td class="SubHead" valign="top">
                    <asp:Label ID="lblPassword" runat="server" meta:resourcekey="lblPassword" Text="Password:"></asp:Label><br />
        ...
        <scp:CollapsiblePanel id="headContact" runat="server" IsCollapsed="true" TargetControlID="pnlContact"
