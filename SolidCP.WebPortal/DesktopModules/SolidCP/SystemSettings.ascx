...
<div class="FormBody">
	<scp:CollapsiblePanel id="lclSmtpSettings" runat="server"
	...
	<scp:CollapsiblePanel id="lclBackupSettings" runat="server"
    ...
    <scp:CollapsiblePanel id="lclWpiSettings" runat="server"
    ...
    <scp:CollapsiblePanel id="HeaderFileManagerSettings" runat="server"
    ...
    <scp:CollapsiblePanel ID="RdsSettings" runat="server" TargetControlID="PanelRdsSettings" meta:resourcekey="RdsSettings" Text="RDS" />
    ...
    <scp:CollapsiblePanel ID="WebdavPortalSettings" runat="server" TargetControlID="PanelWebdavPortalSettings" meta:resourcekey="WebdavPortalSettings" Text="Webdav Portal" />
    ...
    <scp:CollapsiblePanel ID="OwaSettings" runat="server" TargetControlID="PanelOwaSettings" meta:resourcekey="OwaSettings" Text="Office Web Apps" />
    ...
    <scp:CollapsiblePanel ID="TwilioSettings" runat="server" TargetControlID="PanelTwilioSettings" meta:resourcekey="TwilioSettings" Text="Webdav Portal" />
    ...
    <scp:CollapsiblePanel ID="AccessIPsSettings" runat="server" TargetControlID="PanelAccessIPs"  Text="Administrator IP access restriction settings" />
    <asp:Panel ID="PanelAccessIPs" runat="server" Height="0" style="overflow:hidden;">
        <table>
			<tr>
				<td class="SubHead" style="width:200px;">IP Address
				<td><div style="float:left"><asp:TextBox runat="server" TextMode="MultiLine" Rows="10" ID="txtIPAddress" Width="450px" /></div>
                    <div style="
    width: 50%;
    float: left;
    padding-left: 10px;
">To Restrict administrator access to specific ip's you can use single IP's and subnets (/26 /24 /22, etc..) 
Put one IP per line and comma separate them.
                       <br /><br />
