            ...
            <div class="FormBody">
               <asp:MultiView ID="tabs" runat="server" ActiveViewIndex="0">
                ...
                <div class="FormFooter">
                    <asp:Button ID="btnUpdate" runat="server" Text="Update" meta:resourcekey="btnUpdate" CssClass="Button1" OnClick="btnUpdate_Click" OnClientClick="ShowProgressDialog('Updating virtual directory...');" />
                    ...
                    <asp:Button ID="btnDelete" runat="server" Text="Delete" meta:resourcekey="btnDelete" CssClass="Button1" CausesValidation="false" OnClientClick="return confirm('Delete this virtual directory?');" OnClick="btnDelete_Click" />
                </div>
           </div>
        </td>
    </tr>
