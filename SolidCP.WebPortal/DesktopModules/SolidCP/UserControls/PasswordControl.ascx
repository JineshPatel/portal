    ...
    <tr>
        ...
        <td class="Normal">
            ...
            <asp:CustomValidator ID="valCorrectLength" runat="server"
                ...
                ClientValidationFunction="scpValidatePasswordLength" OnServerValidate="valCorrectLength_ServerValidate"></asp:CustomValidator>
            <asp:CustomValidator ID="valRequireNumbers" runat="server"
                ...
                ClientValidationFunction="scpValidatePasswordNumbers" OnServerValidate="valRequireNumbers_ServerValidate"></asp:CustomValidator>
            <asp:CustomValidator ID="valRequireUppercase" runat="server"
                ...
                ClientValidationFunction="scpValidatePasswordUppercase" OnServerValidate="valRequireUppercase_ServerValidate"></asp:CustomValidator>
            <asp:CustomValidator ID="valRequireSymbols" runat="server"
                ...
                ClientValidationFunction="scpValidatePasswordSymbols" OnServerValidate="valRequireSymbols_ServerValidate"></asp:CustomValidator>
        </td>
    </tr>
</table>
