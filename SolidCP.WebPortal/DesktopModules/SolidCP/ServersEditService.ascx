...
<div class="FormBody">
	...
	<br />
	<scp:CollapsiblePanel id="SettingsHeader" runat="server" TargetControlID="SettingsPanel"
	...
	<asp:Panel ID="DnsRecrodsPanel" runat="server">
		<table width="450px">
			<tr>
				<td>
					<scp:GlobalDnsRecordsControl ID="GlobalDnsRecordsControl" runat="server" IPServerIDParam="ServerID"
