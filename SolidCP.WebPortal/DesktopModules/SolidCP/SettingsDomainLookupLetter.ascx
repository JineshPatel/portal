...
<table>
	...
	<tr>
		<td class="Normal" colspan="2">
			<asp:TextBox ID="txtNoChangesHtmlBody" runat="server" Rows="15" TextMode="MultiLine" Width="100%" CssClass="NormalTextBox" Wrap="false"></asp:TextBox></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="Normal" colspan="2">
			<asp:TextBox ID="txtNoChangesTextBody" runat="server" Rows="15" TextMode="MultiLine" Width="100%" CssClass="NormalTextBox" Wrap="false"></asp:TextBox></td>
	</tr>
</table>